...
<div class="post_social_divs" style=" background-color:#F1F1E6;"><img src="/static/icons/vectortw.svg" style="width: 20px; height: 20px; margin-left: 14px; margin-top: 14px; float: left;"></div>
            ...
            <a href="${marker[1].source}" target="_blank" style="margin-left:65px; display:block; color:black; margin-bottom: 50px; width: 60%; word-wrap: break-word;"> წყარო</a>
...
<div class="post_social_divs" style=" background-color:#F1F1E6;"><img src="/static/icons/vectortw.svg" style="width: 20px; height: 20px; margin-left: 14px; margin-top: 14px; float: left;"></div>
            ${postvisual}
            <span class="pinedpostbody">${marker[1].body}</span>
            <a href="${marker[1].source}" target="_blank" style="margin-left:25px; display:block; color:black; margin-bottom: 50px;>წყარო</a>
